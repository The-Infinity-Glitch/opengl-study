...
use std::{ptr, str, mem, os::raw::c_void, ffi::CString};
...
fn main() {
    ...
    let (shader_program, vao) = unsafe {
        ...
        if sucess != gl::TRUE as GLint {
            ...
            println!("ERROR::SHADER::VERTEX::COMPILATION_FALIED\n{}", str::from_utf8(&info_log).unwrap());
        }
        ...
        if sucess != gl::TRUE as GLint {
            ...
            println!("ERROR::SHADER::FRAGMENT::COMPILATION_FALIED\n{}", str::from_utf8(&info_log).unwrap());
        }
        ...
        if sucess != gl::TRUE as GLint {
            gl::GetShaderInfoLog(shader_program, 512, ptr::null_mut(), info_log.as_mut_ptr() as *mut GLchar);
            println!("ERROR::SHADER::PROGRAM::COMPILATION_FALIED\n{}", str::from_utf8(&info_log).unwrap());
        }
